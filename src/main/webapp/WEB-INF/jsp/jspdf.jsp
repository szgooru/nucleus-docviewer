...
<html dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="../pdfdotjs/web/viewer.css"/>
    <script type="text/javascript" src="//ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js"></script>
    <script src="../pdfdotjs/web/compatibility.js"></script>
    <link rel="resource" type="application/l10n" href="../pdfdotjs/web/locale/locale.properties"/>
    <script src="../pdfdotjs/web/l10n.js"></script>
    <script src="../pdfdotjs/build/pdf.js"></script>
    <script type="text/javascript">
      var protocol = ('https:' == document.location.protocol ? 'https://' : 'http://');
      var DEFAULT_URL = '${pdfFile}'; DEFAULT_URL = DEFAULT_URL.replace("http://", protocol);
    ...
    <script type="text/javascript" src="../pdfdotjs/web/viewer.js"></script>
  </head>
   <body tabindex="1">
      ...
      <div id="mainContainer">
        ...
        <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
          <div id="secondaryToolbarButtonContainer">
            ...
            <button id="firstPage" class="secondaryToolbarButton firstPage" title="Go to First Page" tabindex="56" data-l10n-id="first_page" style="display:none">
              <span data-l10n-id="first_page_label">Go to First Page</span>
            </button>
            <button id="lastPage" class="secondaryToolbarButton lastPage" title="Go to Last Page" tabindex="57" data-l10n-id="last_page" style="display:none">
